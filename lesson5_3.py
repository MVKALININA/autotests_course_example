...
def everything_for_your_cat(cats_data):
    """
    Функция принимает в себя кортеж из элементов: имя, возраст кота; имя, фамилия владельца.
    Возвращает строку с оптимизированными данными: Имя_покупателя Фамилия_покупателя: Кличка_котика1, Возраст; ...;
    Кличка_котикаN, Возраст\n
    :param cats_data: кортеж из исходных элементов
    :return: отформатированная строка
    """
    dict_cats = {}
    our_str = ''
    for j in cats_data:
        cats = j[0] + ', ' + str(j[1])  # имя кота, возраст
        dict_cats.setdefault(j[2:], []).append(cats)
        # проверяем, если имя фамилии владельца нет в словаре, то добавляем; если есть - обновить добавлением кота
    for k, v in dict_cats.items():  # получаем ключ и значение по каждому элементу итерации
        our_str = our_str + ' '.join(k) + ': ' + '; '.join(v) + '\n'  # итоговая строка: владелец: кот/возраст
    return our_str
