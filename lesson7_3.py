...
class PublicTransport:
    """
    Класс, состоящий из транспортных средств
    """
    def __init__(self, brand: str, engine_power: int, year: int, color: str, max_speed: int):
        """
        Метод инициализирует характеристики: марка, мощность двигателя, цвет, год выпуска и максимальная скорость
        :param brand: строка марки транспорта
        :param engine_power: число мощности двигателя
        :param year: число года выпуска
        :param color: строка цвета
        :param max_speed: число максимальной скорости
        """
        self.brand = brand
    ...
    def info(self):
        ...
        :return: вывод на печать информацию о марке, цвете, годе выпуска и мощности двигателя
        """
...
class Bus(PublicTransport):
    """
    Унаследованный класс транспорта (2 уровень)
    """
    def __init__(self, brand: str, engine_power: int, year: int, color: str, max_speed: int, passengers: int,
        ...
        :param park: число парка приписки транспорта
        :param fare: число стоимости проезда
        """
    ...
    def park(self):
        """
        Метод принимает в себя характеристики экземпляра класса
        :return: приватный атрибут парк приписки транспорта
        """
        return self.__park
    ...
    def park(self, park):
        """
        Метод принимает в себя характеристику парк экземпляра класса
        :param park: защищенный атрибут
        :return: номер парка
        """
...
class Tram(PublicTransport):
    """
    Унаследованный класс (3 уровень)
    """
    ...
    def how_long(self):
        ...
        :return: время прохождения маршрута по формуле max_speed/(4*path)
        """
